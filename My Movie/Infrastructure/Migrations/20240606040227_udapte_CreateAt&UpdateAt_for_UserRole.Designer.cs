...
namespace My_Movie.Migrations
{
    ...
    [Migration("20240606040227_udapte_CreateAt&UpdateAt_for_UserRole")]
    partial class udapte_CreateAtUpdateAt_for_UserRole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("My_Movie.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddedAt = new DateTime(2024, 6, 6, 4, 2, 26, 19, DateTimeKind.Utc).AddTicks(2296),
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 6, 6, 4, 2, 26, 19, DateTimeKind.Utc).AddTicks(2295),
                            UserId = 6
                        });
                });
